...
module NeblioAPI
  class GetTxResponse
    ...
    attr_accessor :value_out

    # Total NEBL input in this transaction
    attr_accessor :value_in
    ...
    def self.openapi_types
      {
        ...
        :'version' => :'Float',
        :'locktime' => :'Float',
        :'vin' => :'Array<GetTxResponseVin>',
        :'vout' => :'Array<GetTxResponseVout>',
        :'blocktime' => :'Float',
        :'blockheight' => :'Float',
        :'totalsent' => :'Float',
        :'fee' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NeblioAPI::GetTxResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NeblioAPI::GetTxResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'value_out')
        self.value_out = attributes[:'value_out']
      end

      if attributes.key?(:'value_in')
        self.value_in = attributes[:'value_in']
      end
    ...
    def hash
      [txid, version, locktime, vin, vout, blocktime, blockheight, totalsent, fee, blockhash, time, confirmations, value_out, value_in, fees, size].hash
    end
