  ...
  class IssueTokenRequestMetadata
    ...
    def self.openapi_types
      {
        ...
        :'issuer' => :'String',
        :'description' => :'String',
        :'urls' => :'Array<IssueTokenRequestMetadataUrls>',
        :'user_data' => :'GetTokenMetadataResponseMetadataOfIssuanceDataUserData',
        :'encryptions' => :'Array<IssueTokenRequestMetadataEncryptions>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NeblioAPI::IssueTokenRequestMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NeblioAPI::IssueTokenRequestMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'encryptions')
        if (value = attributes[:'encryptions']).is_a?(Array)
    ...
    def hash
      [token_name, issuer, description, urls, user_data, encryptions, rules].hash
    end
