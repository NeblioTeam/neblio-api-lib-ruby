...
module NeblioAPI
  class GetTokenMetadataResponse
    ...
    attr_accessor :initial_issuance_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'initial_issuance_amount')
        self.initial_issuance_amount = attributes[:'initial_issuance_amount']
      end
      ...
      if attributes.key?(:'metadata_of_issuance')
        self.metadata_of_issuance = attributes[:'metadata_of_issuance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          initial_issuance_amount == o.initial_issuance_amount &&
    ...
    def hash
      [token_id, some_utxo, divisibility, lock_status, aggregation_policy, initial_issuance_amount, total_supply, num_of_holders, num_of_transfers, num_of_issuance, num_of_burns, first_block, issuance_txid, issue_address, metadata_of_issuance, metadata_of_utxo].hash
    end
