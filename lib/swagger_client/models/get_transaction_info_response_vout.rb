...
module SwaggerClient
  ...
  class GetTransactionInfoResponseVout
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scriptPubKey')
        self.script_pub_key = attributes[:'scriptPubKey']
      end
      ...
      if attributes.has_key?(:'usedBlockheight')
        self.used_blockheight = attributes[:'usedBlockheight']
      end

      if attributes.has_key?(:'usedTxid')
        self.used_txid = attributes[:'usedTxid']
      end
