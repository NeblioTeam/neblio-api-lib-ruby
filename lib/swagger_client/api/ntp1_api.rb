...
module SwaggerClient
  class NTP1Api
    ...
    def broadcast_tx(body, opts = {})
      data, _status_code, _headers = broadcast_tx_with_http_info(body, opts)
      return data
    end
    ...
    def broadcast_tx_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NTP1Api.broadcast_tx ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NTP1Api.broadcast_tx"
      end
      # resource path
    ...
    def burn_token(body, opts = {})
      data, _status_code, _headers = burn_token_with_http_info(body, opts)
      return data
    end
    ...
    def burn_token_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NTP1Api.burn_token ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NTP1Api.burn_token"
      end
      # resource path
    ...
    def issue_token(body, opts = {})
      data, _status_code, _headers = issue_token_with_http_info(body, opts)
      return data
    end
    ...
    def issue_token_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NTP1Api.issue_token ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NTP1Api.issue_token"
      end
      # resource path
    ...
    def send_token(body, opts = {})
      data, _status_code, _headers = send_token_with_http_info(body, opts)
      return data
    end
    ...
    def send_token_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: NTP1Api.send_token ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling NTP1Api.send_token"
      end
      # resource path
