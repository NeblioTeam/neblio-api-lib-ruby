...
module SwaggerClient
  class InsightApi
    ...
    def send_tx(body, opts = {})
      data, _status_code, _headers = send_tx_with_http_info(body, opts)
      return data
    end
    ...
    def send_tx_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: InsightApi.send_tx ..."
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling InsightApi.send_tx"
      end
      # resource path
