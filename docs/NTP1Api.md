...
begin
  #Builds a transaction that burns an NTP1 Token
  result = api_instance.burn_token(body)
  p result
rescue SwaggerClient::ApiError => e
...
begin
  #Get Issuance Metadata of Token
  result = api_instance.get_token_metadata_of_issuance(tokenid)
  p result
rescue SwaggerClient::ApiError => e
  puts "Exception when calling NTP1Api->get_token_metadata_of_issuance: #{e}"
end
```
...
begin
  #Builds a transaction that issues a new NTP1 Token
  result = api_instance.issue_token(body)
  p result
rescue SwaggerClient::ApiError => e
...
begin
  #Builds a transaction that sends an NTP1 Token
  result = api_instance.send_token(body)
  p result
rescue SwaggerClient::ApiError => e
