...
api_instance = NeblioAPI::TestnetInsightApi.new
...
> Array&lt;Object&gt; testnet_get_address_utxos(address)
...
# **testnet_get_status**
> Object testnet_get_status(opts)
...
begin
  #Broadcasts a signed raw transaction to the network (not NTP1 specific)
  result = api_instance.testnet_send_tx(send_tx_request)
  p result
rescue NeblioAPI::ApiError => e
